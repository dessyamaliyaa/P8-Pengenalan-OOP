public class CetakSiswa2{
    public static void main(String[] args){
        ...
        data.no_absen =1; // variabel no_absen object class Siswa dengan nilai 1
        System.out.println("No. Absen\t\t: "+data.no_absen); 

        data.setNis("160001"); // pemanggilan method setNis pada object class Siswa diberi nilai parameter 160001
